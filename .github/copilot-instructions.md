...
- **Git Commands Need Extra Care**: Before running any bulk `git checkout`, `git restore`, or `git clean`, make sure intentional work is committed, branched, or stashed, and prune junk surgically instead. This principle exists because of the severe work loss incident captured in the [2025-11-15 dev log](../AI-Agent-Workspace/ChatHistory/2025/11/Summarized/2025-11-15.SUMMARIZED.md).
