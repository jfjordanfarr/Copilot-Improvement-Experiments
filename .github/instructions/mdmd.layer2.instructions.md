...
- Begin with the canonical metadata block:
  ```markdown
  ## Metadata
  - Layer: 2
...
- Keep all links workspace-relative.  If no evidence is available, note the gap in `### Evidence` and surface a placeholder in the generated block.
