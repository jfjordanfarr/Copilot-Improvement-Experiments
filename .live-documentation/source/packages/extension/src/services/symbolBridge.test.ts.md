...
- Generated At: 2025-11-16T16:08:44.211Z

## Authored
### Purpose
Ensures the symbol bridge synthesizes link evidence, hints, and seeds from VS Code symbol/reference data.

### Notes
- Replaces VS Code APIs with in-memory mocks to control document symbols, reference results, and open text documents.
...
## Generated
<!-- LIVE-DOC:PROVENANCE {"generators":[{"tool":"live-docs-generator","version":"0.1.0","generatedAt":"2025-11-16T16:08:44.211Z","inputHash":"6c299a0d465a63e4"}]} -->
...
### Dependencies
- `@copilot-improvement/shared` - `ArtifactSeed` (type-only)
- [`symbolBridge.SymbolBridgeAnalyzer`](./symbolBridge.ts.md#symbolbridgeanalyzer)
...
### Targets
#### Vitest Unit Tests
- packages/extension/src/services: [symbolBridge.ts](./symbolBridge.ts.md)
