...
- Generated At: 2025-11-16T02:09:51.049Z

## Authored
### Purpose
Checks the formatting helpers used by the document diagnostic provider so code actions stay descriptive.

### Notes
- Ensures link relationship kinds map to the correct quick-fix titles and fall back sensibly when metadata is missing.
...
## Generated
<!-- LIVE-DOC:PROVENANCE {"generators":[{"tool":"live-docs-generator","version":"0.1.0","generatedAt":"2025-11-16T02:09:51.049Z","inputHash":"3bc0201ab1dfbc10"}]} -->
...
### Dependencies
- [`docDiagnosticProvider.buildOpenActionTitle`](./docDiagnosticProvider.ts.md#buildopenactiontitle)
- [`docDiagnosticProvider.buildRippleSummary`](./docDiagnosticProvider.ts.md#buildripplesummary)
- [`docDiagnosticProvider.formatConfidenceLabel`](./docDiagnosticProvider.ts.md#formatconfidencelabel)
...
### Targets
#### Vitest Unit Tests
- packages/extension/src/commands: [acknowledgeDiagnostic.ts](../commands/acknowledgeDiagnostic.ts.md)
- packages/extension/src/diagnostics: [docDiagnosticProvider.ts](./docDiagnosticProvider.ts.md)
