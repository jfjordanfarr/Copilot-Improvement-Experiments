...
- Generated At: 2025-11-16T16:08:44.073Z

## Authored
### Purpose
Exercises helper utilities that format dependency inspection results before they reach the UI.

### Notes
- Validates `describeEdgePath` so transitive paths render as human-friendly breadcrumbs while direct edges omit noise.
...
## Generated
<!-- LIVE-DOC:PROVENANCE {"generators":[{"tool":"live-docs-generator","version":"0.1.0","generatedAt":"2025-11-16T16:08:44.073Z","inputHash":"d016c05bafe3385c"}]} -->
...
### Dependencies
- [`dependencyQuickPick.InspectDependenciesResultValidator`](./dependencyQuickPick.ts.md#inspectdependenciesresultvalidator)
- [`dependencyQuickPick.ParsedEdge`](./dependencyQuickPick.ts.md#parsededge)
- [`dependencyQuickPick.describeEdgePath`](./dependencyQuickPick.ts.md#describeedgepath)
...
### Targets
#### Vitest Unit Tests
- packages/extension/src/diagnostics: [dependencyQuickPick.ts](./dependencyQuickPick.ts.md)
