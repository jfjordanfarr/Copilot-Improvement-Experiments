...
- Generated At: 2025-11-16T02:09:50.941Z

## Authored
### Purpose
Verifies the `analyzeWithAI` command wiring so AI-assisted diagnostic assessments are registered, gated, and persisted correctly.

### Notes
- Mocks the VS Code surface to confirm the command is registered and that disabled AI settings short-circuit without hitting the language client.
...
## Generated
<!-- LIVE-DOC:PROVENANCE {"generators":[{"tool":"live-docs-generator","version":"0.1.0","generatedAt":"2025-11-16T02:09:50.941Z","inputHash":"a0799d0f4b159a34"}]} -->
...
### Dependencies
- [`llmInvoker.InvokeChatResult`](../services/llmInvoker.ts.md#invokechatresult) (type-only)
- [`llmInvoker.LlmInvoker`](../services/llmInvoker.ts.md#llminvoker) (type-only)
- [`configService.LinkDiagnosticsSettings`](../settings/configService.ts.md#linkdiagnosticssettings) (type-only)
- [`vscodeMock.getSharedVscodeMock`](../testUtils/vscodeMock.ts.md#getsharedvscodemock)
...
### Targets
#### Vitest Unit Tests
- packages/extension/src/commands: [analyzeWithAI.ts](./analyzeWithAI.ts.md)
- packages/extension/src/services: [llmInvoker.ts](../services/llmInvoker.ts.md)
- packages/extension/src/settings: [configService.ts](../settings/configService.ts.md)
