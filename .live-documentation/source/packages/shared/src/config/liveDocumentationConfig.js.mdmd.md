# packages/shared/src/config/liveDocumentationConfig.js
...
## Authored
### Purpose
CommonJS build artifact that re-exports the Live Documentation config defaults and normaliser for Node-based tooling.
