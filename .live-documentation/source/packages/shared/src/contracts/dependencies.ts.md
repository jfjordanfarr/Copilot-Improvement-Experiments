...
- Generated At: 2025-11-16T02:09:51.746Z

## Authored
### Purpose
Describes the language client/server contract for inspecting dependency fan-out from a given artifact, exposing the request identifier, accepted filters, and shape of the graph the server returns.

### Notes
- `InspectDependenciesParams` lets callers cap traversal depth or limit relationship kinds without leaking server defaults into the extension.
...
## Generated
<!-- LIVE-DOC:PROVENANCE {"generators":[{"tool":"live-docs-generator","version":"0.1.0","generatedAt":"2025-11-16T02:09:51.746Z","inputHash":"0acd629c31ba0d5f"}]} -->
