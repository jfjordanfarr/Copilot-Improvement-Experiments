...
- Generated At: 2025-11-16T02:09:51.800Z

## Authored
### Purpose
Defines the shared types that heuristics and fallback inference use to describe candidate matches, trace context, and the lifecycle hooks each heuristic implements.

### Notes
- `HeuristicArtifact` captures the normalized metadata (stem, basename, comparable path) heuristics rely on to perform language-agnostic matching without repeatedly recomputing path transforms.
...
## Generated
<!-- LIVE-DOC:PROVENANCE {"generators":[{"tool":"live-docs-generator","version":"0.1.0","generatedAt":"2025-11-16T02:09:51.800Z","inputHash":"362bccdd86f085f0"}]} -->
