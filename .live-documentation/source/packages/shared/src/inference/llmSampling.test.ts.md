...
- Generated At: 2025-11-16T02:09:51.907Z
...
## Generated
<!-- LIVE-DOC:PROVENANCE {"generators":[{"tool":"live-docs-generator","version":"0.1.0","generatedAt":"2025-11-16T02:09:51.907Z","inputHash":"ab00c55ce918af30"}]} -->
...
### Dependencies
- [`llmSampling.SamplingRequest`](./llmSampling.ts.md#samplingrequest)
- [`llmSampling.SamplingVote`](./llmSampling.ts.md#samplingvote)
- [`llmSampling.aggregateVotes`](./llmSampling.ts.md#aggregatevotes)
- [`llmSampling.emitSamplingTelemetry`](./llmSampling.ts.md#emitsamplingtelemetry)
- [`llmSampling.runSamplingSession`](./llmSampling.ts.md#runsamplingsession)
- [`llmSampling.scoreSamples`](./llmSampling.ts.md#scoresamples)
...
### Targets
#### Vitest Unit Tests
- packages/shared/src/inference: [llmSampling.ts](./llmSampling.ts.md)
