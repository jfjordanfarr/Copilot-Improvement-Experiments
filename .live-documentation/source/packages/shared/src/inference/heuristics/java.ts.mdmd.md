...
### Notes
- Builds a package index during initialization by combining each file’s declared package with its primary class name, skipping JDK imports to avoid noise.
