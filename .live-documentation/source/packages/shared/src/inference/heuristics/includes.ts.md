...
- Generated At: 2025-11-16T02:09:51.848Z

## Authored
### Purpose
Looks for `#include` directives in C-family sources and turns local includes into link relationships when matching headers exist in the candidate set.

### Notes
- Ignores angle-bracket system includes to avoid linking to standard library headers we do not track in the workspace.
...
## Generated
<!-- LIVE-DOC:PROVENANCE {"generators":[{"tool":"live-docs-generator","version":"0.1.0","generatedAt":"2025-11-16T02:09:51.848Z","inputHash":"68fde05dd403ba77"}]} -->
...
- [`referenceResolver.resolveIncludeReference`](./referenceResolver.ts.md#resolveincludereference)
