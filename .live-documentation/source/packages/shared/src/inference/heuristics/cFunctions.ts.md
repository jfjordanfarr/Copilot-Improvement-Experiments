...
- Generated At: 2025-11-16T02:09:51.825Z

## Authored
### Purpose
Indexes C source files for function definitions and emits `depends_on` edges when other translation units call those functions, filling gaps when LSIF/SCIP data is missing.

### Notes
- Builds a name-to-artifact map during `initialize`, stripping comments to avoid false positives from documentation snippets.
...
## Generated
<!-- LIVE-DOC:PROVENANCE {"generators":[{"tool":"live-docs-generator","version":"0.1.0","generatedAt":"2025-11-16T02:09:51.825Z","inputHash":"367932f3821ccba9"}]} -->
