...
- Generated At: 2025-11-16T02:09:51.872Z

## Authored
### Purpose
Detects `require_relative` statements and links Ruby files to their dependencies when they live alongside each other in the repo.

### Notes
- Normalizes relative paths against the source directory, appending `.rb` if omitted, so references resolve regardless of author style.
...
## Generated
<!-- LIVE-DOC:PROVENANCE {"generators":[{"tool":"live-docs-generator","version":"0.1.0","generatedAt":"2025-11-16T02:09:51.872Z","inputHash":"c2b5e88e8d8b3dc2"}]} -->
