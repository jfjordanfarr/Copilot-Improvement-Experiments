...
- Generated At: 2025-11-14T18:42:06.693Z

## Authored
### Purpose
Provides quick predicates for distinguishing documentation-focused layers from implementation layers so heuristics can tailor link strategies.

### Notes
- `isDocumentLayer` treats vision, requirements, and architecture artifacts as narrative sources that typically point outward.
- `isImplementationLayer` groups implementation and code layers so heuristics can gate language-specific analyses to executable files.

## Generated
<!-- LIVE-DOC:PROVENANCE {"generators":[{"tool":"live-docs-generator","version":"0.1.0","generatedAt":"2025-11-14T18:42:06.693Z","inputHash":"2d6d8343a51875a3"}]} -->
