...
- Generated At: 2025-11-16T02:09:52.149Z
...
## Generated
<!-- LIVE-DOC:PROVENANCE {"generators":[{"tool":"live-docs-generator","version":"0.1.0","generatedAt":"2025-11-16T02:09:52.149Z","inputHash":"9a47f5ec35c37582"}]} -->
...
- `node:os` - `os`
- `node:path` - `path`
- [`symbolReferences.findSymbolReferenceAnomalies`](./symbolReferences.ts.md#findsymbolreferenceanomalies)
...
### Targets
#### Vitest Unit Tests
- packages/shared/src/tooling: [githubSlugger.ts](./githubSlugger.ts.md), [githubSluggerRegex.ts](./githubSluggerRegex.ts.md), [markdownShared.ts](./markdownShared.ts.md), [symbolReferences.ts](./symbolReferences.ts.md)
