...
- Generated At: 2025-11-16T02:09:52.113Z
...
## Generated
<!-- LIVE-DOC:PROVENANCE {"generators":[{"tool":"live-docs-generator","version":"0.1.0","generatedAt":"2025-11-16T02:09:52.113Z","inputHash":"bca43c3a5e6d0d9d"}]} -->
...
- `node:os` - `tmpdir`
- `node:path` - `path`
- [`markdownLinks.findBrokenMarkdownLinks`](./markdownLinks.ts.md#findbrokenmarkdownlinks)
...
### Targets
#### Vitest Unit Tests
- packages/shared/src/tooling: [markdownLinks.ts](./markdownLinks.ts.md), [markdownShared.ts](./markdownShared.ts.md)
