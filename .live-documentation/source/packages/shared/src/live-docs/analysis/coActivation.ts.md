...
- Generated At: 2025-11-16T02:09:51.946Z
...
## Generated
<!-- LIVE-DOC:PROVENANCE {"generators":[{"tool":"live-docs-generator","version":"0.1.0","generatedAt":"2025-11-16T02:09:51.946Z","inputHash":"ed0dc3023504e06d"}]} -->
...
### Dependencies
- [`types.Stage0Doc`](../types.ts.md#stage0doc) (type-only)
- [`types.TargetManifest`](../types.ts.md#targetmanifest) (type-only)
...
- [coActivation.test.ts](./coActivation.test.ts.md)
