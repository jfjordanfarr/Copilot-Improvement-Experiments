...
- Generated At: 2025-11-16T16:08:45.575Z
...
## Generated
<!-- LIVE-DOC:PROVENANCE {"generators":[{"tool":"live-docs-generator","version":"0.1.0","generatedAt":"2025-11-16T16:08:45.575Z","inputHash":"fe810d38044ebc15"}]} -->
...
- packages/shared/src/live-docs/adapters: [adapters/index.ts](./index.ts.md), [c.ts](./c.ts.md), [csharp.ts](./csharp.ts.md), [java.ts](./java.ts.md), [python.ts](./python.ts.md), [ruby.ts](./ruby.ts.md)
  [rust.ts](./rust.ts.md)
