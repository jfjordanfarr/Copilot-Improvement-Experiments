...
- Generated At: 2025-11-16T02:09:51.978Z

## Authored
### Purpose
Bundle the built-in relationship resolvers that translate markdown links or MDMD metadata into concrete artifact matches for rule chains.
...
## Generated
<!-- LIVE-DOC:PROVENANCE {"generators":[{"tool":"live-docs-generator","version":"0.1.0","generatedAt":"2025-11-16T02:09:51.978Z","inputHash":"adbb5c0a571829c8"}]} -->
...
- [`relationshipRuleTypes.RelationshipResolverOptions`](./relationshipRuleTypes.ts.md#relationshipresolveroptions) (type-only)
- [`relationshipRuleTypes.RelationshipResolverResult`](./relationshipRuleTypes.ts.md#relationshipresolverresult) (type-only)
- [`markdownShared.extractReferenceDefinitions`](../tooling/markdownShared.ts.md#extractreferencedefinitions)
- [`markdownShared.parseLinkTarget`](../tooling/markdownShared.ts.md#parselinktarget)
