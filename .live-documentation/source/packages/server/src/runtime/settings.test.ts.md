...
- Generated At: 2025-11-16T16:08:45.185Z

## Authored
### Purpose
Confirms the runtime settings parsers extract valid extension configuration from both nested payloads and test-mode overrides while rejecting malformed values.

### Notes
- Builds representative nested initialization objects to verify `extractExtensionSettings` filters out invalid relationship kinds and preserves supported fields.
...
## Generated
<!-- LIVE-DOC:PROVENANCE {"generators":[{"tool":"live-docs-generator","version":"0.1.0","generatedAt":"2025-11-16T16:08:45.185Z","inputHash":"738fb82081b65f72"}]} -->
...
### Dependencies
- [`settings.extractExtensionSettings`](./settings.ts.md#extractextensionsettings)
- [`settings.extractTestModeOverrides`](./settings.ts.md#extracttestmodeoverrides)
...
- packages/server/src/runtime: [settings.ts](./settings.ts.md)
