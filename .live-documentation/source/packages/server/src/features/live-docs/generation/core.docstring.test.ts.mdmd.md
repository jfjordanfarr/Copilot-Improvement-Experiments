...
- Generated At: 2025-11-15T01:50:43.337Z
...
## Generated
<!-- LIVE-DOC:PROVENANCE {"generators":[{"tool":"live-docs-generator","version":"0.1.0","generatedAt":"2025-11-15T01:50:43.337Z","inputHash":"f314d44ffd59cd25"}]} -->
...
- packages/server/src/features/live-docs/generation/adapters: [adapters/index.ts](./adapters/index.ts.mdmd.md), [csharp.ts](./adapters/csharp.ts.mdmd.md), [java.ts](./adapters/java.ts.mdmd.md), [python.ts](./adapters/python.ts.mdmd.md), [ruby.ts](./adapters/ruby.ts.mdmd.md), [rust.ts](./adapters/rust.ts.mdmd.md)
