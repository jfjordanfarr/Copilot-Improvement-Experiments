...
- Generated At: 2025-11-15T01:50:43.404Z
...
## Generated
<!-- LIVE-DOC:PROVENANCE {"generators":[{"tool":"live-docs-generator","version":"0.1.0","generatedAt":"2025-11-15T01:50:43.404Z","inputHash":"a0f91a566a197d44"}]} -->
...
### Dependencies
- `@copilot-improvement/shared/live-docs/types` - `TargetManifest` (type-only)
- `node:fs/promises` - `fs`
- `node:path` - `path`
