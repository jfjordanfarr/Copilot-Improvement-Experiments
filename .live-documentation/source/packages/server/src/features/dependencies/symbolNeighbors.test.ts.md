...
- Generated At: 2025-11-16T16:08:44.385Z

## Authored
### Purpose
Confirms symbol neighbor lookups return the expected related artifacts, respecting depth limits and filtering rules.

### Notes
- Seeds a miniature graph with functions, tests, and documentation to verify grouping logic covers every neighbor kind.
- Ensures repeated invocations produce deterministic ordering so UI consumers can rely on stable lists.

## Generated
<!-- LIVE-DOC:PROVENANCE {"generators":[{"tool":"live-docs-generator","version":"0.1.0","generatedAt":"2025-11-16T16:08:44.385Z","inputHash":"dbe7ba4e29fab7d0"}]} -->
...
### Dependencies
- `@copilot-improvement/shared` - `GraphStore`, `KnowledgeArtifact`, `LinkRelationship`, `SymbolNeighborGroup`
- [`symbolNeighbors.inspectSymbolNeighbors`](./symbolNeighbors.ts.md#inspectsymbolneighbors)
...
### Targets
#### Vitest Unit Tests
- packages/server/src/features/dependencies: [symbolNeighbors.ts](./symbolNeighbors.ts.md)
