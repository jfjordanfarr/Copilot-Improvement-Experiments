# packages/server/src/features/knowledge/lsifParser.test.ts
...
- Generated At: 2025-11-16T16:08:44.792Z

## Authored
### Purpose
Regression-tests the LSIF parser to confirm it emits artifacts, relationships, and metadata from representative dumps.

### Notes
- Covers definition/reference extraction, URI normalisation, snapshot metadata, and default confidence handling.
- Mocks console warnings to ensure malformed lines are skipped without breaking snapshot generation.

## Generated
<!-- LIVE-DOC:PROVENANCE {"generators":[{"tool":"live-docs-generator","version":"0.1.0","generatedAt":"2025-11-16T16:08:44.792Z","inputHash":"e5c745dfb4074668"}]} -->
...
### Dependencies
- [`lsifParser.parseLSIF`](./lsifParser.ts.md#parselsif)
...
### Targets
#### Vitest Unit Tests
- packages/server/src/features/knowledge: [lsifParser.ts](./lsifParser.ts.md)
