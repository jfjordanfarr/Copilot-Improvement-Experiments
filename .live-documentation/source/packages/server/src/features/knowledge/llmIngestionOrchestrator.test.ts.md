...
- Generated At: 2025-11-16T16:08:44.750Z

## Authored
### Purpose
Validates that LLM ingestion persists calibrated relationships with provenance and that dry-run mode emits snapshots without mutating the graph.

### Notes
- Uses a real `GraphStore` to assert link upserts, provenance records, and skipped candidates when required artifacts are missing.
...
## Generated
<!-- LIVE-DOC:PROVENANCE {"generators":[{"tool":"live-docs-generator","version":"0.1.0","generatedAt":"2025-11-16T16:08:44.750Z","inputHash":"4a0340292cc59905"}]} -->
...
- [`llmIngestionOrchestrator.LlmIngestionOrchestrator`](./llmIngestionOrchestrator.ts.md#llmingestionorchestrator)
...
### Targets
#### Vitest Unit Tests
- packages/server/src/features/knowledge: [llmIngestionOrchestrator.ts](./llmIngestionOrchestrator.ts.md)
- packages/server/src/features/settings: [providerGuard.ts](../settings/providerGuard.ts.md)
- packages/server/src/prompts/llm-ingestion: [relationshipTemplate.ts](../../prompts/llm-ingestion/relationshipTemplate.ts.md)
