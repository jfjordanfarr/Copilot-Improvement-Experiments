# packages/server/src/features/knowledge/scipParser.test.ts
...
- Generated At: 2025-11-16T16:08:44.834Z

## Authored
### Purpose
Exercises the SCIP parser to ensure it emits artifacts, cross-file links, and metadata across representative index scenarios.

### Notes
- Validates reference generation, write-as-depends-on promotion, language inference, and snapshot metadata defaults.
- Includes safeguards for same-document references and unknown languages so ingestion does not create noisy edges.

## Generated
<!-- LIVE-DOC:PROVENANCE {"generators":[{"tool":"live-docs-generator","version":"0.1.0","generatedAt":"2025-11-16T16:08:44.834Z","inputHash":"9a39ddc1df600eae"}]} -->
...
### Dependencies
- `@copilot-improvement/shared` - `SCIPIndex` (type-only)
- [`scipParser.parseSCIP`](./scipParser.ts.md#parsescip)
...
### Targets
#### Vitest Unit Tests
- packages/server/src/features/knowledge: [scipParser.ts](./scipParser.ts.md)
