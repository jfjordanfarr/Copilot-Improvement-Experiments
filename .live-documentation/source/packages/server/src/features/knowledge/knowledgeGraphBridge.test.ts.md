...
- Generated At: 2025-11-16T16:08:44.655Z
...
## Generated
<!-- LIVE-DOC:PROVENANCE {"generators":[{"tool":"live-docs-generator","version":"0.1.0","generatedAt":"2025-11-16T16:08:44.655Z","inputHash":"62bffb9c67010cff"}]} -->
...
- `node:os` - `tmpdir`
- `node:path` - `path`
- [`knowledgeGraphBridge.KnowledgeGraphBridgeLogger`](./knowledgeGraphBridge.ts.md#knowledgegraphbridgelogger)
- [`knowledgeGraphBridge.KnowledgeGraphBridgeService`](./knowledgeGraphBridge.ts.md#knowledgegraphbridgeservice)
...
### Targets
#### Vitest Unit Tests
- packages/server/src/features/knowledge: [feedCheckpointStore.ts](./feedCheckpointStore.ts.md), [feedDiagnosticsGateway.ts](./feedDiagnosticsGateway.ts.md), [feedFormatDetector.ts](./feedFormatDetector.ts.md), [knowledgeFeedManager.ts](./knowledgeFeedManager.ts.md), [knowledgeGraphBridge.ts](./knowledgeGraphBridge.ts.md), [knowledgeGraphIngestor.ts](./knowledgeGraphIngestor.ts.md)
  [lsifParser.ts](./lsifParser.ts.md), [schemaValidator.ts](./schemaValidator.ts.md), [scipParser.ts](./scipParser.ts.md)
