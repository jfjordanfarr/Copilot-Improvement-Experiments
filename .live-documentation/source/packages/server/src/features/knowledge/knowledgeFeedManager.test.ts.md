...
- Generated At: 2025-11-16T16:08:44.603Z

## Authored
### Purpose
Validates feed manager scheduling, checkpoint updates, and telemetry emission across success and failure cases.

### Notes
- Employs fake feed definitions and stub orchestrators to assert lifecycle callbacks without hitting real data sources.
- Confirms failed runs mark feeds unhealthy and invoke diagnostics gateways with actionable context.

## Generated
<!-- LIVE-DOC:PROVENANCE {"generators":[{"tool":"live-docs-generator","version":"0.1.0","generatedAt":"2025-11-16T16:08:44.603Z","inputHash":"df5bd4ca9a6100d1"}]} -->
...
### Dependencies
- `@copilot-improvement/shared` - `ExternalSnapshot`, `ExternalStreamEvent`, `GraphStore`, `KnowledgeGraphBridge`
...
### Targets
#### Vitest Unit Tests
- packages/server/src/features/knowledge: [feedCheckpointStore.ts](./feedCheckpointStore.ts.md), [feedDiagnosticsGateway.ts](./feedDiagnosticsGateway.ts.md), [knowledgeFeedManager.ts](./knowledgeFeedManager.ts.md), [knowledgeGraphIngestor.ts](./knowledgeGraphIngestor.ts.md), [schemaValidator.ts](./schemaValidator.ts.md)
