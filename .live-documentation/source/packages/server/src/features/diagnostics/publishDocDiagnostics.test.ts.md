...
- Generated At: 2025-11-16T02:09:51.292Z

## Authored
### Purpose
Ensures documentation diagnostic publishing respects noise suppression rules, acknowledgements, hysteresis, and broken-link detection while producing stable telemetry totals.

### Notes
- Exercises scenarios with ripple impacts, budget exhaustion, and suppressed acknowledgements to verify the result counters (`suppressedByBudget`, etc.) reflect reality.
- Injects stub `AcknowledgementService` and `HysteresisController` to simulate acknowledgement gating without hitting the real graph store.
...
## Generated
<!-- LIVE-DOC:PROVENANCE {"generators":[{"tool":"live-docs-generator","version":"0.1.0","generatedAt":"2025-11-16T02:09:51.292Z","inputHash":"eea59c532ab587a1"}]} -->
...
### Dependencies
- `@copilot-improvement/shared` - `DiagnosticRecord`, `KnowledgeArtifact` (type-only)
...
- [`publishDocDiagnostics.DocumentChangeContext`](./publishDocDiagnostics.ts.md#documentchangecontext)
- [`publishDocDiagnostics.publishDocDiagnostics`](./publishDocDiagnostics.ts.md#publishdocdiagnostics)
...
### Targets
#### Vitest Unit Tests
- packages/server/src/features/changeEvents: [changeQueue.ts](../changeEvents/changeQueue.ts.md)
- packages/server/src/features/diagnostics: [acknowledgementService.ts](./acknowledgementService.ts.md), [diagnosticUtils.ts](./diagnosticUtils.ts.md), [hysteresisController.ts](./hysteresisController.ts.md), [noiseFilter.ts](./noiseFilter.ts.md), [publishDocDiagnostics.ts](./publishDocDiagnostics.ts.md), [rippleTypes.ts](./rippleTypes.ts.md)
...
- packages/server/src/features/watchers: [artifactWatcher.ts](../watchers/artifactWatcher.ts.md), [pathReferenceDetector.ts](../watchers/pathReferenceDetector.ts.md)
