...
- Generated At: 2025-11-16T16:08:45.102Z

## Authored
### Purpose
Proves the path reference detector emits high-confidence hints for markdown links and code imports while ignoring unreachable or external targets.

### Notes
- Constructs real fixture URIs from the integration sandbox to exercise filesystem resolution paths.
- Asserts detected hints carry the expected relationship kind and confidence for document→code and code→document scenarios.
- Verifies http URLs and missing files are filtered out, preventing noisy hints from polluting inference runs.

## Generated
<!-- LIVE-DOC:PROVENANCE {"generators":[{"tool":"live-docs-generator","version":"0.1.0","generatedAt":"2025-11-16T16:08:45.102Z","inputHash":"805e094174cfff47"}]} -->
...
- [`pathReferenceDetector.buildFileReferenceHints`](./pathReferenceDetector.ts.md#buildfilereferencehints)
...
- packages/server/src/features/watchers: [pathReferenceDetector.ts](./pathReferenceDetector.ts.md)
