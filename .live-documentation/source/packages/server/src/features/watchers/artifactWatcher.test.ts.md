...
- Generated At: 2025-11-16T02:09:51.659Z

## Authored
### Purpose
Exercises the artifact watcher end to end so document/code edits become tracked changes, populate inference seeds, and yield results without skips or errors.

### Notes
- Fakes document content via the `TextDocument` store and stubs graph-store accessors to isolate watcher logic from the real database.
- Processes both markdown and TypeScript changes to confirm layer classification, content length calculation, and inference orchestration work for mixed batches.
...
## Generated
<!-- LIVE-DOC:PROVENANCE {"generators":[{"tool":"live-docs-generator","version":"0.1.0","generatedAt":"2025-11-16T02:09:51.659Z","inputHash":"49194be3582b42d0"}]} -->
...
### Dependencies
- `@copilot-improvement/shared` - `GraphStore`, `LinkInferenceOrchestrator`
- `node:path` - `path`
- `node:url` - `pathToFileURL`
- [`changeQueue.QueuedChange`](../changeEvents/changeQueue.ts.md#queuedchange) (type-only)
- [`artifactWatcher.ArtifactWatcher`](./artifactWatcher.ts.md#artifactwatcher)
...
- packages/server/src/features/watchers: [artifactWatcher.ts](./artifactWatcher.ts.md), [pathReferenceDetector.ts](./pathReferenceDetector.ts.md)
