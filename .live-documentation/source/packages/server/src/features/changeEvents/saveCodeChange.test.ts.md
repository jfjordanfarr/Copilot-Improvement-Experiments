...
- Generated At: 2025-11-16T02:09:51.172Z

## Authored
### Purpose
Validates code change persistence captures artifacts, ripple hints, and queue scheduling while handling acknowledgement hooks.

### Notes
- Uses a temporary SQLite graph store to mirror real persistence behaviour and verify changes are replayed during diagnostics.
- Injects fake acknowledgement and queue adapters so the test can assert on interactions without executing background jobs.

## Generated
<!-- LIVE-DOC:PROVENANCE {"generators":[{"tool":"live-docs-generator","version":"0.1.0","generatedAt":"2025-11-16T02:09:51.172Z","inputHash":"136f926f2df87d6c"}]} -->
...
- [`saveCodeChange.saveCodeChange`](./saveCodeChange.ts.md#savecodechange)
...
### Targets
#### Vitest Unit Tests
- packages/server/src/features/changeEvents: [changeQueue.ts](./changeQueue.ts.md), [saveCodeChange.ts](./saveCodeChange.ts.md)
