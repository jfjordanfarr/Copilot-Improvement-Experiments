# tests/integration/fixtures/powershell-compendium/common/logging.ps1
...
## Authored
### Purpose
Provide a dot-sourced logging helper that the deployment script can import while we validate PowerShell dependency detection.
