...
## Collaborators
- [`scripts/fixture-tools/regenerate-benchmarks.ts`](../../../../scripts/fixture-tools/regenerate-benchmarks.ts) orchestrates interpreter detection, oracle execution, and diff artefact staging for both TypeScript and Python fixtures.
...
## Evidence
- [`packages/shared/src/testing/fixtureOracles/pythonFixtureOracle.test.ts`](../../../../packages/shared/src/testing/fixtureOracles/pythonFixtureOracle.test.ts) exercises override handling, merge determinism, and serialization guarantees.
